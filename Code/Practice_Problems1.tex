...
\begin{subsubequations}
    ...
    \begin{alignat}{2}
        & & & \nonumber \\
        % &&&u = \sec(x^{12}) \quad du = 12x^{11}\sec(x^{12})\tan(x^{12})dx \quad dx = \frac{du}{12x^{11}\sec(x^{12})\tan(x^{12})} \\[0.5ex]
        % &&\implies &\int 5x^{11}u\tan(x^{12})\frac{du}{12x^{11}\sec(x^{12})\tan(x^{12})} \\[0.5ex]
        % &&\implies &\frac{5}{12}\int \frac{u}{\sec(x^{12})}\,du \\[0.5ex]
        % &&\implies &\frac{5}{12}\int \frac{u}{\left(\dfrac{1}{\cos(x^{12})}\right)}\,du \\[0.5ex]
        % &&\implies &\frac{5}{12}\int u\cos(x^{12}) \,du \\[0.5ex]
