...
% __Preamble__
\usepackage{microtype, amsmath, physics, enumitem, etoolbox, mathtools}
\usepackage[letterpaper]{geometry}

% __Changing Subequation format to number.number
\renewcommand{\theparentequation}{\arabic{equation}}
\renewcommand{\theequation}{\thesection.\arabic{equation}}
\numberwithin{equation}{section}
\renewcommand{\subequations}{\thesection.\arabic{equation}}
\numberwithin{equation}{section}
...
% We want to rewrite this equation as:
% \[ 
%     \frac{1}{y}\,dy = x\,dx 
%     \quad \text{or} \quad 
%     \frac{1}{\mathrm{g}(y)}\,dy = \mathrm{h}(x)\,dx 
% \]
% Basically, one side is in terms of $y$ and the other is in terms of $x$.
% \begin{align}
%     &(1+x^2)y' = \frac{1}{y^2} \\
%     &(1+x^2)\frac{dy}{dx} = \frac{1}{y^2} = \frac{(1+x^2)dy}{dx} = \frac{1}{y^2} \\
%     \Rightarrow\: &y^2(1+x^2)dy = dx \\
%     \Rightarrow\: &y^2\,dy = (1+x^2)^{-1}\,dx
% \end{align}
% Now to integrate:
% \begin{align}
%     &\int y^2\,dy = \int \frac{1}{1+x^2}\,dx \\
%     &\frac{y^3}{3} + C = \arctan(x) + C \Longleftrightarrow \frac{1}{3}y^3 = \arctan(x) + C \\
%     \Rightarrow\: &y^3 + C = 3\arctan(x) + C \\
%     \Rightarrow\: &y = \sqrt[3]{3\arctan(x)} + C
% \end{align}
% Now to find $C$ such that the condition $y(0) = 2$ or $y = 2$ when $x = 0$ is satisfied:
% \begin{align}
%     &2 = \sqrt[3]{3\arctan(2)}+C \\
%     \Rightarrow\: &C = 2-\sqrt[3]{3\arctan(x)}
% \end{align}
% \end{subequations}
